...
public class BidConst {
     ...
     * 注册状态
     */
    public static final int REG_STATE_NORMAL = 0;
    public static final int REG_STATE_LOCK = 1;
    /**
     * 登陆记录
     */
    public static final int IP_STATE_FAIL = 0;
    public static final int IP_STATE_SUCCESS = 1;
    /**
     * 用户类型
     */
     ...
     * 手机验证的有效时间
     */
    public static final long VERIFYCODE_VALIDATE_TIME = 300L;
    /**
     * 邮箱绑定有效期
     */
     ...
     * 实名认证状态
     */
    //正常状态，用户提交实名认证申请，等待审核
    public static final int AUDIT_STATE_NORMAL = 0;
    //实名认证审核通过
    public static final int AUDIT_STATE_AUTH = 1;
    //实名认证拒绝
    ...
    // 冻结金额减少
    public final static int ACCOUNT_ACTIONTYPE_BIDREQUEST_SUCCESSFUL = 2;// 资金流水类别：成功借款。可用余额增加（借款人）
    // 可用余额增加
    public final static int ACCOUNT_ACTIONTYPE_BID_SUCCESSFUL = 3;// 资金流水类别：成功投标。冻结金额减少（投资人）
    // 冻结金额减少
    public final static int ACCOUNT_ACTIONTYPE_RETURN_MONEY = 4;// 资金流水类别：还款。可用余额减少（借款人）
    // 可用余额减少
    public final static int ACCOUNT_ACTIONTYPE_CALLBACK_MONEY = 5;// 资金流水类别：回款。可用余额增加（投资人）
    // 可用余额增加
    public final static int ACCOUNT_ACTIONTYPE_CHARGE = 6;// 资金流水类别：支付平台管理费。可用余额减少（借款人）
    // 可用余额减少
    public final static int ACCOUNT_ACTIONTYPE_INTEREST_SHARE = 7;// 资金流水类别：利息管理费。可用余额减少（投资人）
    // 可用余额减少
    public final static int ACCOUNT_ACTIONTYPE_WITHDRAW_MANAGE_CHARGE = 8;// 资金流水类别：提现手续费。可用余额减少（投资人）
    // 可用余额减少
    public final static int ACCOUNT_ACTIONTYPE_RECHARGE_CHARGE = 9;// 资金流水类别：充值手续费。可用余额减少（投资人）
    // 可用余额减少
    public final static int ACCOUNT_ACTIONTYPE_BID_FREEZED = 10;// 资金流水类别：投标冻结金额。冻结金额增加，可用余额减少
    // 冻结金额增加 可用余额减少
    public final static int ACCOUNT_ACTIONTYPE_BID_UNFREEZED = 11;// 资金流水类别：取消投标冻结金额。满标审核不通过
    // 标审核失败
    // 冻结金额减少
    // 可用余额增加
