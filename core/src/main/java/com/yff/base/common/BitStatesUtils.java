...
public class BitStatesUtils {
	...
	public final static Long OP_REAL_AUTH = 1L << 3; // 用户是否已经实名认证 8
	public final static Long OP_VEDIO_AUTH = 1L << 4; // 用户是否已经视频认证 16
	public final static Long OP_HAS_BIDREQUEST_PROCESS = 1L << 5; // 用户是否已经有一个借款申请在申请流程中 32
