                ...
                <tr>
                    <td colspan="2">
                        <div style="margin-bottom: 10px;" class="progress">
                            <div style="width: ${(bidRequest.percent/100)?string.percent}"
					...
					<#if bidRequest.bidRequestState==1>
                        ...
                        <#elseif account?? && !self>
						<input id="usableAmount" autocomplete="off" value="${account.usableAmount?string('0.##')}"
                               type="hidden"/>
						<input id="minBidAmount" autocomplete="off" value="${bidRequest.minBidAmount?string('0.##')}"
                               type="hidden"/>
						<input id="maxBidAmount" autocomplete="off" value="${bidRequest.remainAmount?string('0.##')}"
                               type="hidden"/>
